...
const dashboardController = {
  ...
  getMonthlyData: async (req, res) => {
    try {
      ...
      // Get monthly expenses excluding paid, reimbursed and cancelled expense items
  ...
  getExpensesByDepartment: async (req, res) => {
    try {
      ...
      // First, let's check if we have any active expense items (exclude paid, reimbursed and cancelled)
  ...
  getMonthlyProfitData: async (req, res) => {
    try {
      ...
      for (let month = 1; month <= 12; month++) {
        ...
        // Get expenses for this month (exclude paid, reimbursed and cancelled expense items)
