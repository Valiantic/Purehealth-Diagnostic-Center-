...
export const exportIncomeToExcel = async (
  ...
  try {
    ...
    const cash = Math.max(0, totalGross - totalRefunds - totalGCash);
    ...
    // Add borders to main data table (excluding title and date rows)
    ...
    const summaryEndRow = summaryStartRow + 2; // Title + 2 data rows
