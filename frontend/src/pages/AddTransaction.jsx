...
const NewAddTransaction = () => {
  ...
  const createTransactionMutation = useMutation({
    ...
    onSuccess: (response) => {
      ...
      // Display "Processing..." or backend-generated MC# from response
      setGeneratedMcNo(response?.data?.transaction?.mcNo || 'Processing...');
    },
    onError: (error) => {
  ...
  const handleConfirmTransaction = () => {
    ...
    try {
      ...
      const transactionData = {
        // mcNo will be auto-generated by backend
  ...
  useEffect(() => {
    // Display placeholder until first transaction is created
    setGeneratedMcNo('Auto-generated');
  }, []);
