                    ...
                    <table className="w-full text-sm">
                      <thead className='sticky top-0 bg-green-100 z-10'>
                        <tr className="border-b border-green-800 bg-green-100">
                          <th className="p-1 border-r border-green-800 text-sm font-medium text-left uppercase tracking-wide">Department Name</th>
                          <th className="p-1 border-r border-green-800 text-sm font-medium text-center uppercase tracking-wide">Test Quantity</th>
                        ...
                        {isLoading ? (
                          ...
                          currentDepartments.map((dept) => (
                            <tr key={dept.departmentId} className="border-b border-green-200">
                              <td className="p-1 pl-5 border-r border-green-200 text-left">{dept.departmentName || 'N/A'}</td>
                              <td className="p-1 border-r border-green-200 text-center">{dept.testQuantity ?? 'N/A'}</td>
                              <td className="p-1 border-r border-green-200 text-center">{dept.createdAt ? new Date(dept.createdAt).toLocaleDateString() : 'N/A'}</td>
